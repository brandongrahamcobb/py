...
class Project:
    ...
    def __init__(self):
        ...
        self.PATH_DOCUMENTS_PY_TAG_COG = join(self.COBBBRANDONGRAHAM, 'Documents', 'py', 'bot', 'cogs', f'CobbBrandonGraham_tag_cog_{self.CURRENT_DATE}.py')
        ...
        self.PATH_SRC_LICENSE = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'LICENSE')
        self.PATH_SRC_PY_ADMIN_COG = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'bot', 'cogs', 'admin_cog.py')
        self.PATH_SRC_PY_COGS_INIT = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'bot', 'cogs', '__init__.py')
        self.PATH_SRC_PY_GAME_COG = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'bot', 'cogs', 'game_cog.py')
        self.PATH_SRC_PY_HELPERS = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'bot', 'utils', 'helpers.py')
        self.PATH_SRC_PY_INIT = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'bot', '__init__.py')
        self.PATH_SRC_PY_MAIN = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'bot', 'main.py')
        self.PATH_SRC_PY_MY_COG = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'bot', 'cogs', 'my_cog.py')
        self.PATH_SRC_PY_SETUP = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'setup.py')
        self.PATH_SRC_PY_TAG_COG = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'bot', 'cogs', 'tag_cog.py')
        self.PATH_SRC_PY_USER_COG = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'bot', 'cogs', 'user_cog.py')
        self.PATH_SRC_PY_UTILS_INIT = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'bot', 'utils', '__init__.py')
        self.PATH_SRC_TXT_REQUIREMENTS = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'requirements.txt')
        self.PATH_SRC_README = join(self.COBBBRANDONGRAHAM, 'Documents', 'src', f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}', 'README.md')
...
if __name__ == '__main__':
    ...
    makedirs(dirname(self.PATH_SRC_PY_GAME_COG), exist_ok=True)
    ...
    makedirs(dirname(self.PATH_SRC_PY_TAG_COG), exist_ok=True)
    ...
    shutil.copy2(self.PATH_DOCUMENTS_PY_TAG_COG, self.PATH_SRC_PY_TAG_COG)
    ...
    verify_copy(self.PATH_DOCUMENTS_PY_TAG_COG, self.PATH_SRC_PY_TAG_COG)
    ...
    with tarfile.open(f'CobbBrandonGraham_lucy_{self.CURRENT_DATE}.tar.gz', 'w:gz') as tar:
        ...
        tar.add(self.PATH_SRC_PY_TAG_COG)
