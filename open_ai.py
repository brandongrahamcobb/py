...
class GPT:
    def __init__(self, api_key: str, model: str, sys_input: str, stream: bool):
    ...
    async def completion(self, input_text: str, conversation_id: str):
        ...
        try:
            ...
            messages.append({'role': 'system', 'content': self.sys_input})
...
class AI:
    ...
    def __init__(self, api_key: str, model: str, sys_input: str, stream: bool, **kwargs):
    ...
    def _get_config(cls) -> Dict[str, Any]:
        ...
        if cls._config is None:
            ...
            data['model'] = prompt_for_values('Enter model name', data.get('model', 'gpt-4'))
            data['sys_input'] = prompt_for_values('Enter system input', data.get('sys_input', ''))
