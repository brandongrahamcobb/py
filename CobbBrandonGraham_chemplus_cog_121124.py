''' chemplus_cog.py The purpose of this program is to add non-essential, chemistry features to a Discord bot. 
...
class ChemPlusCog(commands.Cog):
...
async def setup(bot: commands.Bot):
    await bot.add_cog(ChemPlusCog(bot))
